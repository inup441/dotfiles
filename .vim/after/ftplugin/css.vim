...
if has("gui_running") || &t_Co==256
  ...
  augroup PreviewCSSColor
    ...
    autocmd CursorHold *.sass silent call s:PreviewCSSColorInLine('.')
    autocmd CursorHoldI *.sass silent call s:PreviewCSSColorInLine('.')
    autocmd InsertLeave *.sass silent call s:PreviewCSSColorInLine('.')
  augroup END
